...
export default async function PmPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* Loop 74 (§16 "Responsive Model" harder half): Plans and Instances
          are two independent lists stacked one above the other on mobile/
          tablet - at lg:+ there's room to run them side by side instead of
          a long single column. Below lg: this is unchanged (still two
          stacked <section>s in the same order), matching the Loop 70/72/73
          precedent of only introducing lg:/xl: structure. */}
